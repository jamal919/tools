...
#define FUNCTIONS_H_includes_POC_ASSERTIONS_H 1
...
extern void assert_array_(FILE *f,const char *path,int line,const string &name,const double *array,int n,int dm);
extern void assert_array_(FILE *f,const char *path,int line,const string &name,const float  *array,int n,int dm);
extern void assert_array_(FILE *f,const char *path,int line,const string &name,const int   *array,int n,int dm);

extern void assert_array_(FILE *f,const char *path,int line,const string &name,const vector<double> & array,int n,int dm);
extern void assert_array_(FILE *f,const char *path,int line,const string &name,const vector<int   > & array,int n,int dm);


/*XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX*/

#define ASSERT_ARRAY(f,name,array,n,dm) assert_array_(f,__FILE__,__LINE__,name,array,n,dm)
